...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://staging-biz.coinprofile.co/v2";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("AdminSecret", new ApiKeyAuth("header", "X-Admin-Secret"));
        authentications.put("ApiKey", new ApiKeyAuth("header", "X-Api-Key"));
        authentications.put("ApiUser", new ApiKeyAuth("header", "X-Api-User"));
        authentications.put("UserVersion", new ApiKeyAuth("header", "X-User-Version"));
        ...
        if (configuration != null) {
            if (configuration.adminSecret != null) {
                this.setAdminSecret(configuration.adminSecret);
            }
            if (configuration.apiKey != null) {
                this.setApiKey(configuration.apiKey);
            }
            if (configuration.apiUser != null) {
                this.setApiUser(configuration.apiUser);
            }
            if (configuration.userVersion != null) {
                this.setUserVersion(configuration.userVersion);
            }
    ...
    public String getAdminSecret() {
        return ((ApiKeyAuth) this.getAuthentication("AdminSecret")).getApiKey();
    }

    public void setAdminSecret(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("AdminSecret")).setApiKey(apiKey);
    }

    public void setAdminSecretPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("AdminSecret")).setApiKeyPrefix(prefix);
    }
    ...
    public String getApiUser() {
        return ((ApiKeyAuth) this.getAuthentication("ApiUser")).getApiKey();
    }

    public void setApiUser(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("ApiUser")).setApiKey(apiKey);
    }

    public void setApiUserPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("ApiUser")).setApiKeyPrefix(prefix);
    }
    public String getUserVersion() {
        return ((ApiKeyAuth) this.getAuthentication("UserVersion")).getApiKey();
    }

    public void setUserVersion(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("UserVersion")).setApiKey(apiKey);
    }

    public void setUserVersionPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("UserVersion")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://staging-biz.coinprofile.co/v2)
