...
public class MerchantsUpdateRecordRequest {
 ...
 public enum FeeBearerEnum {
  ...
  public MerchantsUpdateRecordRequest() {
  }

  public MerchantsUpdateRecordRequest callbackUrl(String callbackUrl) {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://www.example.com/webhook/ventogram", value = "Merchant callback URL. Webhook will be sent to this URL.")
  ...
  public MerchantsUpdateRecordRequest creditCurrency(CreditCurrencyEnum creditCurrency) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Merchants can set this property to their desired currency. Their balance on Ventogram will be credited with this currency when their users redeem voucher created on Ventogram. Conversion between different currencies will be performed at the rate which is obtainable at the time of redeeming the voucher. If this is not set by the merchant,  their balance will be credited with the currency used in creating the voucher.")
  ...
  public MerchantsUpdateRecordRequest feeBearer(FeeBearerEnum feeBearer) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CLIENT", value = "Bearer of the voucher fee")
  ...
  public MerchantsUpdateRecordRequest logo(String logo) {
  ...
  **/
   ...
   * @return the MerchantsUpdateRecordRequest instance itself
   */
  public MerchantsUpdateRecordRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MerchantsUpdateRecordRequest merchantsUpdateRecordRequest = (MerchantsUpdateRecordRequest) o;
    return Objects.equals(this.callbackUrl, merchantsUpdateRecordRequest.callbackUrl) &&
        Objects.equals(this.creditCurrency, merchantsUpdateRecordRequest.creditCurrency) &&
        Objects.equals(this.feeBearer, merchantsUpdateRecordRequest.feeBearer) &&
        Objects.equals(this.logo, merchantsUpdateRecordRequest.logo)&&
        Objects.equals(this.additionalProperties, merchantsUpdateRecordRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(callbackUrl, creditCurrency, feeBearer, logo, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MerchantsUpdateRecordRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MerchantsUpdateRecordRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MerchantsUpdateRecordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantsUpdateRecordRequest is not found in the empty JSON string", MerchantsUpdateRecordRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantsUpdateRecordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantsUpdateRecordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantsUpdateRecordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantsUpdateRecordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantsUpdateRecordRequest>() {
           @Override
           public void write(JsonWriter out, MerchantsUpdateRecordRequest value) throws IOException {
           ...
           @Override
           public MerchantsUpdateRecordRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MerchantsUpdateRecordRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MerchantsUpdateRecordRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MerchantsUpdateRecordRequest
  * @throws IOException if the JSON string is invalid with respect to MerchantsUpdateRecordRequest
  */
  public static MerchantsUpdateRecordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantsUpdateRecordRequest.class);
  }

 /**
  * Convert an instance of MerchantsUpdateRecordRequest to an JSON string
  *
  * @return JSON string
  */
